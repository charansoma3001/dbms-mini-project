...
<!--   <div class="padding">
 ...
 -->
  ...
  <footer class="container-fluid text-center">
    <div class="row">
      <div class="col-sm-4">
        <h3>Details</h3>
        <br>
        <h4><b>Address:</b> National Cricket Academy, <br> Queens Rd, Shivaji Nagar, Bengaluru, Karnataka <br> 560001 <br><br> <b>Phone:</b> +91 9875721294</h4>
      </div>
  ...
  <!-- <div class="copyright">
    <p><center>©2021 | All right reserved by Soma Charan Sai</center></p>
  </div> -->
</body>
